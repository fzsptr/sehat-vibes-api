...
apiRouter.get("/workouts/history/weekly", authMiddleware, WorkoutController.getWeek)
apiRouter.get("/workouts/history/statistics", authMiddleware, WorkoutController.getStatistics)
apiRouter.get("/workouts/history/streak", authMiddleware, WorkoutController.getStreak)